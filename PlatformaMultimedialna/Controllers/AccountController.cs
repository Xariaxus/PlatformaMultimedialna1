...
namespace PlatformaMultimedialna.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,UserName,Password,ConfirmPassword")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,UserName,Password,ConfirmPassword")] UserModel userModel)
        {
            if (id != userModel.Id)
            {
                return NotFound();
